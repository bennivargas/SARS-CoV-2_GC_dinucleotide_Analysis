...
covid <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\sequence.fasta")
...
omicron <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\omicron.fasta")
...
MERS <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\MERS.fasta")
MERSFreq <- alphabetFrequency(MERS, as.prob=T)
#another striking observation - an endemic (factcheck) virus has higher GC than SARS-CoV-2
...
SARS2003 <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\SARS2003.fasta")
...
originalCoronavirus <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\firstCoronavirus.fasta")
...
HIV1 <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Final Project\\HIV-1.fasta")
HIV1Freq <- alphabetFrequency(HIV1, as.prob=T)

GC_list[6] <- sum(HIV1Freq[2:3]) * 100

#E. coli
Ecoli <- readDNAStringSet("C:\\Users\\bev25\\Documents\\BIOINF 2018\\Ecoli_Genome.fas.gz")
